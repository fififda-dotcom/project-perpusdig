...
/* Grid layout untuk Card Buku Favorit (3-4 kolom di desktop) */
.paw-grid {
    display: grid;
...
<div class="paw-container">
    ...
    <div class="paw-title-card">
        <h1><i class="fas fa-heart"></i> Buku Favorit</h1>
    </div>
    ...
    <?php if (empty($favorit) && empty($keyword) && empty($ddc_filter)): ?>
        <div class="empty-favorite-container">
            <div class="empty-heart-icon">❤️</div>
            <h3>Belum ada buku favorit.</h3>
            <p>Yuk jelajahi katalog dan simpan buku yang ingin kamu baca nanti!</p>
            <a href="/katalog" class="btn-browse-catalog">
                📚 Jelajahi Katalog
            </a>
        </div>
    <?php else: ?>
        ...
        <div style="margin-bottom: 25px;">
            ...
            <form action="/favorit" method="get" style="display:flex; gap:12px; flex-wrap:wrap; align-items:center;">
                <input type="text"
                    name="keyword"
                    class="search-input"
                ...
                <a href="/favorit" class="btn-reset" style="margin-left:0;">
                    Reset
                </a>
            </form>
        </div>
        ...
        <?php if (empty($favorit) && (!empty($keyword) || !empty($ddc_filter))): ?>
            <!-- SEARCH EMPTY STATE -->
            <div class="empty-favorite-container" style="max-width: 600px; margin: 40px auto;">
                <div style="font-size: 4rem; margin-bottom: 20px;">🔎</div>
                <h3>Buku tidak ditemukan di favorit.</h3>
                <p>Coba gunakan kata kunci lain atau pilih klasifikasi DDC yang berbeda.</p>
            </div>
        <?php else: ?>
            ...
            <?php foreach($favorit as $b): ?>
                ...
                <div class="paw-card">
                    ...
                    <div class="paw-card-footer-stacked">
                        ...
                        <a href="/favorit/toggle/<?= $b['id'] ?>" class="btn-action btn-action-hapus" onclick="return confirm('Hapus buku ini dari daftar favorit?')">
                            <i class="fas fa-times"></i> Hapus dari Favorit
                        </a>
                    </div>
                </div>
